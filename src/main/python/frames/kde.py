...
# Form implementation generated from reading ui file 'D:\Github\health-weather_correlation\src\main\python\ui\frame_kde.ui'
#
...
class Ui_FrameKde(object):
    def setupUi(self, FrameKde):
        ...
        FrameKde.resize(620, 579)
        FrameKde.setMinimumSize(QtCore.QSize(620, 380))

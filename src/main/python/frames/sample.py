...
class Ui_FramePatient(object):
    def setupUi(self, FramePatient):
        ...
        self.text_main_1.setMinimumSize(QtCore.QSize(100, 200))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.text_main_1.setFont(font)
        self.text_main_1.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.text_main_1.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.text_main_2.sizePolicy().hasHeightForWidth())
        self.text_main_2.setSizePolicy(sizePolicy)
        self.text_main_2.setMinimumSize(QtCore.QSize(100, 200))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.text_main_2.setFont(font)
        self.text_main_2.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.text_main_2.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
